# peak_detector.py
# Finds the peaks in an ECG signal
...
LOGGER = logging.getLogger("peak_detector")

### Classes ###

class PeakDetector:
    # Class constants, customized to sampling frequency of ESP
    ...
    def __init__(self, controller):
        ...
        self.empty_packet_count = 1 #s et it as 1 here for computation purposes

        LOGGER.info("Peak detection class initialized")
    ...
    def run_peak_detection(self, data):
        LOGGER.info("Starting analysis of new set of data")
        indices_peaks = []
        indices_peaks, rate = self.detectPeaks(data)
        LOGGER.info("Analysis complete")
        
        self.controller.interface.send_heart_rate(str(int(round(rate))))